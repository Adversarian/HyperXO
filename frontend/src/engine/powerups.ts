...
export const CARD_CATALOG: Record<PowerUpCard, CardDef> = {
  ...
  'momentum': {
    ...
    name: 'Momentum',
    category: 'doctrine',
    description: 'When you win a board on your turn, take an extra turn.',
    flavor: 'Snowball',
    passive: true,
    targetType: 'none',
  },
  ...
  'arsenal': {
    ...
    name: 'Arsenal',
    category: 'doctrine',
    description: 'When you win a board on your turn, recharge a random used card (not the one played this turn).',
    flavor: 'Resupply',
    passive: true,
    targetType: 'none',
  },
